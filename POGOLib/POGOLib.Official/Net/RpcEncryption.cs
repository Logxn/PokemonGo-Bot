    ...
    internal class RpcEncryption
    {
        ...
        private List<Signature.Types.LocationFix> BuildLocationFixes(RequestEnvelope requestEnvelope, long timestampSinceStart)
        {
            ...
            for (var i = 0; i < providerCount; i++)
            {
                ...
                locationFixes.Add(new Signature.Types.LocationFix
                {
        ...
        internal async Task<RequestEnvelope.Types.PlatformRequest> GenerateSignatureAsync(RequestEnvelope requestEnvelope)
        {
