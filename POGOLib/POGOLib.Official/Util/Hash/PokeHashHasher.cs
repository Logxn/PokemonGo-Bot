...
namespace POGOLib.Official.Util.Hash
{
    ...
    public class PokeHashHasher : IHasher
    {
        ...
        public Version PokemonVersion { get; } = new Version("0.73.1");
        
        private static ulong ulong_uk25 = 0xF2AA99D7C5AB3DED;

        public long Unknown25 { get; } = (long) ulong_uk25;
