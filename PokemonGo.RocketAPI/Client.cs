...
namespace PokemonGo.RocketAPI
{
    ...
    public class Client
    {
        ...
        public async Task<CatchPokemonResponse> CatchPokemon(ulong encounterId, string spawnPointGuid, double pokemonLat, double pokemonLng, MiscEnums.Item pokeball)
        {
            ...
            var catchPokemonRequest = RequestBuilder.GetRequest(this._unknownAuth, this.CurrentLat, this.CurrentLng, 30, new Request.Types.Requests
                                                                                                                         {
        ...
        public async Task<EncounterResponse> EncounterPokemon(ulong encounterId, string spawnPointGuid)
        {
            ...
            var encounterResponse = RequestBuilder.GetRequest(this._unknownAuth, this.CurrentLat, this.CurrentLng, 30, new Request.Types.Requests
                                                                                                                       {
        ...
        public async Task<EvolvePokemonOut> EvolvePokemon(ulong pokemonId)
        {
            ...
            var releasePokemonRequest = RequestBuilder.GetRequest(this._unknownAuth, this.CurrentLat, this.CurrentLng, 30, new Request.Types.Requests
                                                                                                                           {
        ...
        public async Task<FortDetailsResponse> GetFort(string fortId, double fortLat, double fortLng)
        {
            ...
            var fortDetailRequest = RequestBuilder.GetRequest(this._unknownAuth, this.CurrentLat, this.CurrentLng, 10, new Request.Types.Requests
                                                                                                                       {
        ...
        {
            var inventoryRequest = RequestBuilder.GetRequest(this._unknownAuth, this.CurrentLat, this.CurrentLng, 30, RequestType.GET_INVENTORY);
        ...
        public async Task<FortSearchResponse> SearchFort(string fortId, double fortLat, double fortLng)
        {
            ...
            var fortDetailRequest = RequestBuilder.GetRequest(this._unknownAuth, this.CurrentLat, this.CurrentLng, 30, new Request.Types.Requests
                                                                                                                       {
