...
namespace PokemonGo.RocketAPI.Logic.Utils
{
	partial class CaptchaHelper
	{
		...
		private System.Windows.Forms.Timer timerCheckURLChanges;
		...
		private void InitializeComponent()
		{
		    ...
		    this.timerCheckURLChanges = new System.Windows.Forms.Timer(this.components);
		    this.SuspendLayout();
		    // 
		    // webBrowser1
		    // 
		    ...
		    // 
		    this.timerCheckURLChanges.Enabled = true;
		    ...
		    this.Name = "CaptchaHelper";
		    this.Text = "CaptchaHelper";
