...
namespace POGOProtos.Data.Avatar
{
    ...
    public sealed partial class AvatarCustomization : pb::IMessage<AvatarCustomization>
    {
        ...
        public static partial class Types
        {
            public enum Label
            {
                [pbr::OriginalName("UNSET_LABEL")]
                UnsetLabel = 0,
                [pbr::OriginalName("DEFAULT")]
                Default = 1,
                [pbr::OriginalName("OWNED")]
                Owned = 2,
                [pbr::OriginalName("FEATURED")]
                Featured = 3,
                [pbr::OriginalName("NEW")]
                New = 4,
                [pbr::OriginalName("SALE")]
                Sale = 5,
                [pbr::OriginalName("PURCHASABLE")]
                Purchasable = 6,
                [pbr::OriginalName("UNLOCKABLE")]
                Unlockable = 7,
                [pbr::OriginalName("VIEWED")]
                Viewed = 8,
                [pbr::OriginalName("LOCKED_PURCHASABLE")]
                LockedPurchasable = 9,
            }
