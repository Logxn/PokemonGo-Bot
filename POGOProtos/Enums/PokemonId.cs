...
namespace POGOProtos.Enums
{
    ...
    public enum PokemonId
    {
        ...
        Mew = 151,
        [pbr::OriginalName("CHIKORITA")]
        Chikorita = 152,
        [pbr::OriginalName("BAYLEEF")]
        Bayleef = 153,
        [pbr::OriginalName("MEGANIUM")]
        Meganium = 154,
        [pbr::OriginalName("CYNDAQUIL")]
        Cyndaquil = 155,
        [pbr::OriginalName("QUILAVA")]
        Quilava = 156,
        [pbr::OriginalName("TYPHLOSION")]
        Typhlosion = 157,
        [pbr::OriginalName("TOTODILE")]
        Totodile = 158,
        [pbr::OriginalName("CROCONAW")]
        Croconaw = 159,
        [pbr::OriginalName("FERALIGATR")]
        Feraligatr = 160,
        [pbr::OriginalName("SENTRET")]
        Sentret = 161,
        [pbr::OriginalName("FURRET")]
        Furret = 162,
        [pbr::OriginalName("HOOTHOOT")]
        Hoothoot = 163,
        [pbr::OriginalName("NOCTOWL")]
        Noctowl = 164,
        [pbr::OriginalName("LEDYBA")]
        Ledyba = 165,
        [pbr::OriginalName("LEDIAN")]
        Ledian = 166,
        [pbr::OriginalName("SPINARAK")]
        Spinarak = 167,
        [pbr::OriginalName("ARIADOS")]
        Ariados = 168,
        [pbr::OriginalName("CROBAT")]
        Crobat = 169,
        [pbr::OriginalName("CHINCHOU")]
        Chinchou = 170,
        [pbr::OriginalName("LANTURN")]
        Lanturn = 171,
        [pbr::OriginalName("PICHU")]
        Pichu = 172,
        [pbr::OriginalName("CLEFFA")]
        Cleffa = 173,
        [pbr::OriginalName("IGGLYBUFF")]
        Igglybuff = 174,
        [pbr::OriginalName("TOGEPI")]
        Togepi = 175,
        [pbr::OriginalName("TOGETIC")]
        Togetic = 176,
        [pbr::OriginalName("NATU")]
        Natu = 177,
        [pbr::OriginalName("XATU")]
        Xatu = 178,
        [pbr::OriginalName("MAREEP")]
        Mareep = 179,
        [pbr::OriginalName("FLAAFFY")]
        Flaaffy = 180,
        [pbr::OriginalName("AMPHAROS")]
        Ampharos = 181,
        [pbr::OriginalName("BELLOSSOM")]
        Bellossom = 182,
        [pbr::OriginalName("MARILL")]
        Marill = 183,
        [pbr::OriginalName("AZUMARILL")]
        Azumarill = 184,
        [pbr::OriginalName("SUDOWOODO")]
        Sudowoodo = 185,
        [pbr::OriginalName("POLITOED")]
        Politoed = 186,
        [pbr::OriginalName("HOPPIP")]
        Hoppip = 187,
        [pbr::OriginalName("SKIPLOOM")]
        Skiploom = 188,
        [pbr::OriginalName("JUMPLUFF")]
        Jumpluff = 189,
        [pbr::OriginalName("AIPOM")]
        Aipom = 190,
        [pbr::OriginalName("SUNKERN")]
        Sunkern = 191,
        [pbr::OriginalName("SUNFLORA")]
        Sunflora = 192,
        [pbr::OriginalName("YANMA")]
        Yanma = 193,
        [pbr::OriginalName("WOOPER")]
        Wooper = 194,
        [pbr::OriginalName("QUAGSIRE")]
        Quagsire = 195,
        [pbr::OriginalName("ESPEON")]
        Espeon = 196,
        [pbr::OriginalName("UMBREON")]
        Umbreon = 197,
        [pbr::OriginalName("MURKROW")]
        Murkrow = 198,
        [pbr::OriginalName("SLOWKING")]
        Slowking = 199,
        [pbr::OriginalName("MISDREAVUS")]
        Misdreavus = 200,
        [pbr::OriginalName("UNOWN")]
        Unown = 201,
        [pbr::OriginalName("WOBBUFFET")]
        Wobbuffet = 202,
        [pbr::OriginalName("GIRAFARIG")]
        Girafarig = 203,
        [pbr::OriginalName("PINECO")]
        Pineco = 204,
        [pbr::OriginalName("FORRETRESS")]
        Forretress = 205,
        [pbr::OriginalName("DUNSPARCE")]
        Dunsparce = 206,
        [pbr::OriginalName("GLIGAR")]
        Gligar = 207,
        [pbr::OriginalName("STEELIX")]
        Steelix = 208,
        [pbr::OriginalName("SNUBBULL")]
        Snubbull = 209,
        [pbr::OriginalName("GRANBULL")]
        Granbull = 210,
        [pbr::OriginalName("QWILFISH")]
        Qwilfish = 211,
        [pbr::OriginalName("SCIZOR")]
        Scizor = 212,
        [pbr::OriginalName("SHUCKLE")]
        Shuckle = 213,
        [pbr::OriginalName("HERACROSS")]
        Heracross = 214,
        [pbr::OriginalName("SNEASEL")]
        Sneasel = 215,
        [pbr::OriginalName("TEDDIURSA")]
        Teddiursa = 216,
        [pbr::OriginalName("URSARING")]
        Ursaring = 217,
        [pbr::OriginalName("SLUGMA")]
        Slugma = 218,
        [pbr::OriginalName("MAGCARGO")]
        Magcargo = 219,
        [pbr::OriginalName("SWINUB")]
        Swinub = 220,
        [pbr::OriginalName("PILOSWINE")]
        Piloswine = 221,
        [pbr::OriginalName("CORSOLA")]
        Corsola = 222,
        [pbr::OriginalName("REMORAID")]
        Remoraid = 223,
        [pbr::OriginalName("OCTILLERY")]
        Octillery = 224,
        [pbr::OriginalName("DELIBIRD")]
        Delibird = 225,
        [pbr::OriginalName("MANTINE")]
        Mantine = 226,
        [pbr::OriginalName("SKARMORY")]
        Skarmory = 227,
        [pbr::OriginalName("HOUNDOUR")]
        Houndour = 228,
        [pbr::OriginalName("HOUNDOOM")]
        Houndoom = 229,
        [pbr::OriginalName("KINGDRA")]
        Kingdra = 230,
        [pbr::OriginalName("PHANPY")]
        Phanpy = 231,
        [pbr::OriginalName("DONPHAN")]
        Donphan = 232,
        [pbr::OriginalName("PORYGON2")]
        Porygon2 = 233,
        [pbr::OriginalName("STANTLER")]
        Stantler = 234,
        [pbr::OriginalName("SMEARGLE")]
        Smeargle = 235,
        [pbr::OriginalName("TYROGUE")]
        Tyrogue = 236,
        [pbr::OriginalName("HITMONTOP")]
        Hitmontop = 237,
        [pbr::OriginalName("SMOOCHUM")]
        Smoochum = 238,
        [pbr::OriginalName("ELEKID")]
        Elekid = 239,
        [pbr::OriginalName("MAGBY")]
        Magby = 240,
        [pbr::OriginalName("MILTANK")]
        Miltank = 241,
        [pbr::OriginalName("BLISSEY")]
        Blissey = 242,
        [pbr::OriginalName("RAIKOU")]
        Raikou = 243,
        [pbr::OriginalName("ENTEI")]
        Entei = 244,
        [pbr::OriginalName("SUICUNE")]
        Suicune = 245,
        [pbr::OriginalName("LARVITAR")]
        Larvitar = 246,
        [pbr::OriginalName("PUPITAR")]
        Pupitar = 247,
        [pbr::OriginalName("TYRANITAR")]
        Tyranitar = 248,
        [pbr::OriginalName("LUGIA")]
        Lugia = 249,
        [pbr::OriginalName("HO_OH")]
        HoOh = 250,
        [pbr::OriginalName("CELEBI")]
        Celebi = 251,
    }
