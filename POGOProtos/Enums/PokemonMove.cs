...
namespace POGOProtos.Enums
{
    ...
    public enum PokemonMove
    {
        ...
        TransformFast = 242,
        [pbr::OriginalName("COUNTER_FAST")]
        CounterFast = 243,
        [pbr::OriginalName("POWDER_SNOW_FAST")]
        PowderSnowFast = 244,
        [pbr::OriginalName("CLOSE_COMBAT")]
        CloseCombat = 245,
        [pbr::OriginalName("DYNAMIC_PUNCH")]
        DynamicPunch = 246,
        [pbr::OriginalName("FOCUS_BLAST")]
        FocusBlast = 247,
        [pbr::OriginalName("AURORA_BEAM")]
        AuroraBeam = 248,
        [pbr::OriginalName("CHARGE_BEAM_FAST")]
        ChargeBeamFast = 249,
        [pbr::OriginalName("VOLT_SWITCH_FAST")]
        VoltSwitchFast = 250,
        [pbr::OriginalName("WILD_CHARGE")]
        WildCharge = 251,
        [pbr::OriginalName("ZAP_CANNON")]
        ZapCannon = 252,
        [pbr::OriginalName("DRAGON_TAIL_FAST")]
        DragonTailFast = 253,
        [pbr::OriginalName("AVALANCHE")]
        Avalanche = 254,
        [pbr::OriginalName("AIR_SLASH_FAST")]
        AirSlashFast = 255,
        [pbr::OriginalName("BRAVE_BIRD")]
        BraveBird = 256,
        [pbr::OriginalName("SKY_ATTACK")]
        SkyAttack = 257,
        [pbr::OriginalName("SAND_TOMB")]
        SandTomb = 258,
        [pbr::OriginalName("ROCK_BLAST")]
        RockBlast = 259,
        [pbr::OriginalName("INFESTATION_FAST")]
        InfestationFast = 260,
        [pbr::OriginalName("STRUGGLE_BUG_FAST")]
        StruggleBugFast = 261,
        [pbr::OriginalName("SILVER_WIND")]
        SilverWind = 262,
        [pbr::OriginalName("ASTONISH_FAST")]
        AstonishFast = 263,
        [pbr::OriginalName("HEX_FAST")]
        HexFast = 264,
        [pbr::OriginalName("NIGHT_SHADE")]
        NightShade = 265,
        [pbr::OriginalName("IRON_TAIL_FAST")]
        IronTailFast = 266,
        [pbr::OriginalName("GYRO_BALL")]
        GyroBall = 267,
        [pbr::OriginalName("HEAVY_SLAM")]
        HeavySlam = 268,
        [pbr::OriginalName("FIRE_SPIN_FAST")]
        FireSpinFast = 269,
        [pbr::OriginalName("OVERHEAT")]
        Overheat = 270,
        [pbr::OriginalName("BULLET_SEED_FAST")]
        BulletSeedFast = 271,
        [pbr::OriginalName("GRASS_KNOT")]
        GrassKnot = 272,
        [pbr::OriginalName("ENERGY_BALL")]
        EnergyBall = 273,
        [pbr::OriginalName("EXTRASENSORY_FAST")]
        ExtrasensoryFast = 274,
        [pbr::OriginalName("FUTURESIGHT")]
        Futuresight = 275,
        [pbr::OriginalName("MIRROR_COAT")]
        MirrorCoat = 276,
        [pbr::OriginalName("OUTRAGE")]
        Outrage = 277,
        [pbr::OriginalName("SNARL_FAST")]
        SnarlFast = 278,
        [pbr::OriginalName("CRUNCH")]
        Crunch = 279,
        [pbr::OriginalName("FOUL_PLAY")]
        FoulPlay = 280,
        [pbr::OriginalName("HIDDEN_POWER_FAST")]
        HiddenPowerFast = 281,
    }
