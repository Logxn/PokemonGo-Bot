...
namespace POGOProtos.Enums
{
    ...
    public enum PokemonFamilyId
    {
        ...
        FamilySandshrew = 27,
        [pbr::OriginalName("FAMILY_NIDORAN_FEMALE")]
        FamilyNidoranFemale = 29,
        [pbr::OriginalName("FAMILY_NIDORAN_MALE")]
        FamilyNidoranMale = 32,
        ...
        FamilyMew = 151,
        [pbr::OriginalName("FAMILY_CHIKORITA")]
        FamilyChikorita = 152,
        [pbr::OriginalName("FAMILY_CYNDAQUIL")]
        FamilyCyndaquil = 155,
        [pbr::OriginalName("FAMILY_TOTODILE")]
        FamilyTotodile = 158,
        [pbr::OriginalName("FAMILY_SENTRET")]
        FamilySentret = 161,
        [pbr::OriginalName("FAMILY_HOOTHOOT")]
        FamilyHoothoot = 163,
        [pbr::OriginalName("FAMILY_LEDYBA")]
        FamilyLedyba = 165,
        [pbr::OriginalName("FAMILY_SPINARAK")]
        FamilySpinarak = 167,
        [pbr::OriginalName("FAMILY_CHINCHOU")]
        FamilyChinchou = 170,
        [pbr::OriginalName("FAMILY_TOGEPI")]
        FamilyTogepi = 175,
        [pbr::OriginalName("FAMILY_NATU")]
        FamilyNatu = 177,
        [pbr::OriginalName("FAMILY_MAREEP")]
        FamilyMareep = 179,
        [pbr::OriginalName("FAMILY_MARILL")]
        FamilyMarill = 183,
        [pbr::OriginalName("FAMILY_SUDOWOODO")]
        FamilySudowoodo = 185,
        [pbr::OriginalName("FAMILY_HOPPIP")]
        FamilyHoppip = 187,
        [pbr::OriginalName("FAMILY_AIPOM")]
        FamilyAipom = 190,
        [pbr::OriginalName("FAMILY_SUNKERN")]
        FamilySunkern = 191,
        [pbr::OriginalName("FAMILY_YANMA")]
        FamilyYanma = 193,
        [pbr::OriginalName("FAMILY_WOOPER")]
        FamilyWooper = 194,
        [pbr::OriginalName("FAMILY_MURKROW")]
        FamilyMurkrow = 198,
        [pbr::OriginalName("FAMILY_MISDREAVUS")]
        FamilyMisdreavus = 200,
        [pbr::OriginalName("FAMILY_UNOWN")]
        FamilyUnown = 201,
        [pbr::OriginalName("FAMILY_WOBBUFFET")]
        FamilyWobbuffet = 202,
        [pbr::OriginalName("FAMILY_GIRAFARIG")]
        FamilyGirafarig = 203,
        [pbr::OriginalName("FAMILY_PINECO")]
        FamilyPineco = 204,
        [pbr::OriginalName("FAMILY_DUNSPARCE")]
        FamilyDunsparce = 206,
        [pbr::OriginalName("FAMILY_GLIGAR")]
        FamilyGligar = 207,
        [pbr::OriginalName("FAMILY_SNUBBULL")]
        FamilySnubbull = 209,
        [pbr::OriginalName("FAMILY_QWILFISH")]
        FamilyQwilfish = 211,
        [pbr::OriginalName("FAMILY_SHUCKLE")]
        FamilyShuckle = 213,
        [pbr::OriginalName("FAMILY_HERACROSS")]
        FamilyHeracross = 214,
        [pbr::OriginalName("FAMILY_SNEASEL")]
        FamilySneasel = 215,
        [pbr::OriginalName("FAMILY_TEDDIURSA")]
        FamilyTeddiursa = 216,
        [pbr::OriginalName("FAMILY_SLUGMA")]
        FamilySlugma = 218,
        [pbr::OriginalName("FAMILY_SWINUB")]
        FamilySwinub = 220,
        [pbr::OriginalName("FAMILY_CORSOLA")]
        FamilyCorsola = 222,
        [pbr::OriginalName("FAMILY_REMORAID")]
        FamilyRemoraid = 223,
        [pbr::OriginalName("FAMILY_DELIBIRD")]
        FamilyDelibird = 225,
        [pbr::OriginalName("FAMILY_MANTINE")]
        FamilyMantine = 226,
        [pbr::OriginalName("FAMILY_SKARMORY")]
        FamilySkarmory = 227,
        [pbr::OriginalName("FAMILY_HOUNDOUR")]
        FamilyHoundour = 228,
        [pbr::OriginalName("FAMILY_PHANPY")]
        FamilyPhanpy = 231,
        [pbr::OriginalName("FAMILY_STANTLER")]
        FamilyStantler = 234,
        [pbr::OriginalName("FAMILY_SMEARGLE")]
        FamilySmeargle = 235,
        [pbr::OriginalName("FAMILY_TYROGUE")]
        FamilyTyrogue = 236,
        [pbr::OriginalName("FAMILY_MILTANK")]
        FamilyMiltank = 241,
        [pbr::OriginalName("FAMILY_RAIKOU")]
        FamilyRaikou = 243,
        [pbr::OriginalName("FAMILY_ENTEI")]
        FamilyEntei = 244,
        [pbr::OriginalName("FAMILY_SUICUNE")]
        FamilySuicune = 245,
        [pbr::OriginalName("FAMILY_LARVITAR")]
        FamilyLarvitar = 246,
        [pbr::OriginalName("FAMILY_LUGIA")]
        FamilyLugia = 249,
        [pbr::OriginalName("FAMILY_HO_OH")]
        FamilyHoOh = 250,
        [pbr::OriginalName("FAMILY_CELEBI")]
        FamilyCelebi = 251,
    }
