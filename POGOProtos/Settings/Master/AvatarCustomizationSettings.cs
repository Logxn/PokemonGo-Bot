...
namespace POGOProtos.Settings.Master
{
    ...
    public sealed partial class AvatarCustomizationSettings : pb::IMessage<AvatarCustomizationSettings>
    {
        ...
        public static partial class Types
        {
            ...
            {
                [pbr::OriginalName("UNSET_PROMO_TYPE")]
                UnsetPromoType = 0,
            ...
            {
                [pbr::OriginalName("UNSET_UNLOCK_TYPE")]
                UnsetUnlockType = 0,
                [pbr::OriginalName("DEFAULT")]
                Default = 1,
                [pbr::OriginalName("MEDAL_REWARD")]
                MedalReward = 2,
                [pbr::OriginalName("IAP_CLOTHING")]
                IapClothing = 3,
                [pbr::OriginalName("LEVEL_REWARD")]
                LevelReward = 4,
            }
