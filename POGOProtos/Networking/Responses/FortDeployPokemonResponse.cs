    ...
    public sealed partial class FortDeployPokemonResponse : pb::IMessage<FortDeployPokemonResponse>
    {
        ...
        public static partial class Types
        {
            public enum Result
            {
                ...
                Success = 1,
                [pbr::OriginalName("ERROR_ALREADY_HAS_POKEMON_ON_FORT")]
                ErrorAlreadyHasPokemonOnFort = 2,
                [pbr::OriginalName("ERROR_OPPOSING_TEAM_OWNS_FORT")]
                ErrorOpposingTeamOwnsFort = 3,
                [pbr::OriginalName("ERROR_FORT_IS_FULL")]
                ErrorFortIsFull = 4,
                [pbr::OriginalName("ERROR_NOT_IN_RANGE")]
                ErrorNotInRange = 5,
                [pbr::OriginalName("ERROR_PLAYER_HAS_NO_TEAM")]
                ErrorPlayerHasNoTeam = 6,
                [pbr::OriginalName("ERROR_POKEMON_NOT_FULL_HP")]
                ErrorPokemonNotFullHp = 7,
                [pbr::OriginalName("ERROR_PLAYER_BELOW_MINIMUM_LEVEL")]
                ErrorPlayerBelowMinimumLevel = 8,
                [pbr::OriginalName("ERROR_POKEMON_IS_BUDDY")]
                ErrorPokemonIsBuddy = 9,
                [pbr::OriginalName("ERROR_FORT_DEPLOY_LOCKOUT")]
                ErrorFortDeployLockout = 10,
            }
