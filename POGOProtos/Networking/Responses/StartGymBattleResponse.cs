    ...
    public sealed partial class StartGymBattleResponse : pb::IMessage<StartGymBattleResponse>
    {
        ...
        public static partial class Types
        {
            public enum Result
            {
                ...
                Success = 1,
                [pbr::OriginalName("ERROR_GYM_NOT_FOUND")]
                ErrorGymNotFound = 2,
                [pbr::OriginalName("ERROR_GYM_NEUTRAL")]
                ErrorGymNeutral = 3,
                [pbr::OriginalName("ERROR_GYM_WRONG_TEAM")]
                ErrorGymWrongTeam = 4,
                [pbr::OriginalName("ERROR_GYM_EMPTY")]
                ErrorGymEmpty = 5,
                [pbr::OriginalName("ERROR_INVALID_DEFENDER")]
                ErrorInvalidDefender = 6,
                [pbr::OriginalName("ERROR_TRAINING_INVALID_ATTACKER_COUNT")]
                ErrorTrainingInvalidAttackerCount = 7,
                [pbr::OriginalName("ERROR_ALL_POKEMON_FAINTED")]
                ErrorAllPokemonFainted = 8,
                [pbr::OriginalName("ERROR_TOO_MANY_BATTLES")]
                ErrorTooManyBattles = 9,
                [pbr::OriginalName("ERROR_TOO_MANY_PLAYERS")]
                ErrorTooManyPlayers = 10,
                [pbr::OriginalName("ERROR_GYM_BATTLE_LOCKOUT")]
                ErrorGymBattleLockout = 11,
                [pbr::OriginalName("ERROR_PLAYER_BELOW_MINIMUM_LEVEL")]
                ErrorPlayerBelowMinimumLevel = 12,
                [pbr::OriginalName("ERROR_NOT_IN_RANGE")]
                ErrorNotInRange = 13,
            }
