...
namespace PokemonGo.RocketAPI.Console
{
    public partial class GUI : Form
    {
        ...
        private void checkedlist1_sort_btn_Click(object sender, EventArgs e)
        {
            checkedListBox1.Sorted = true;
        }

        private void checkedlist2_sort_btn_Click(object sender, EventArgs e)
        {
            checkedListBox2.Sorted = true;
        }

        private void checkedlist3_sort_btn_Click(object sender, EventArgs e)
        {
