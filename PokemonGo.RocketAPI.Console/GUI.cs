namespace PokemonGo.RocketAPI.Console
{
    ...
    public partial class GUI : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (this.textBox24.Text == string.Empty)
            {
                this.textBox24.BackColor = Color.Red;
            }
            else
            {
                Globals.ivmaxpercent = int.Parse(this.textBox24.Text);
            }

            Globals.gerNames = this.checkBox8.Checked;
            Globals.useincense = this.checkBox9.Checked;
            Globals.pokeList = this.checkBox10.Checked;
            ...
            string[] accFile =
            {
                Globals.acc.ToString(), Globals.username, Globals.password, Globals.latitute.ToString(), Globals.longitude.ToString(), Globals.altitude.ToString(), Globals.speed.ToString(), Globals.radius.ToString(), Globals.defLoc.ToString(), Globals.transfer.ToString(), Globals.duplicate.ToString(), Globals.evolve.ToString(), Globals.maxCp.ToString(), Globals.telAPI, Globals.telName, Globals.telDelay.ToString(), Globals.navigation_option.ToString(), Globals.useluckyegg.ToString(), Globals.gerNames.ToString(), Globals.useincense.ToString(), Globals.ivmaxpercent.ToString(), Globals.pokeList.ToString(), Globals.keepPokemonsThatCanEvolve.ToString()
            };
        ...
        private void GUI_Load(object sender, EventArgs e)
        {
            ...
            {
                var dialogResult = MessageBox.Show("There is an Update on Github. do you want to open it ?", "Newest Version: " + Program.getNewestVersion(), MessageBoxButtons.YesNo);
            ...
            if (File.Exists(Program.account))
            {
                ...
                foreach (var line in lines)
                {
                    switch (i)
                    {
                        ...
                        case 21:
                            this.textBox24.Text = line;
                            break;

                        case 22:
                            this.checkBox10.Checked = bool.Parse(line);
                            break;

                        case 23:
                            this.checkBox11.Checked = bool.Parse(line);
                            break;
